...
import com.ratnesh.rest.webservice.user.exception.ExceptionResponse;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleMissingMandatoryInformationException(MissingMandatoryInformationException ex, WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
